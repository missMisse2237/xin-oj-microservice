package com.xin.xinojbackendquestionservice.controller;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.google.gson.Gson;

import com.xin.xinojbackendcommon.annotation.AuthCheck;
import com.xin.xinojbackendcommon.common.BaseResponse;
import com.xin.xinojbackendcommon.common.DeleteRequest;
import com.xin.xinojbackendcommon.common.ErrorCode;
import com.xin.xinojbackendcommon.common.ResultUtils;
import com.xin.xinojbackendcommon.constant.UserConstant;
import com.xin.xinojbackendcommon.exception.BusinessException;
import com.xin.xinojbackendcommon.exception.ThrowUtils;
import com.xin.xinojbackendmodel.model.dto.question.*;
...
import com.xin.xinojbackendmodel.model.vo.QuestionVO;
...
public class QuestionController {
    ...
    public BaseResponse<Page<Question>> listQuestionByPage(@RequestBody QuestionQueryRequest questionQueryRequest,
        ...
        Page<Question> questionPagePage = questionService.page(new Page<>(current, size),
                questionService.getQueryWrapper(questionQueryRequest));
        return ResultUtils.success(questionPagePage);
    }
    ...
    /**
     * 根据 id 获取--> 本人是可以拿到题目的所有信息的（用于数据回显
     *
     * @param id
     * @return
     */
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        User loginUser = userFeignClient.getLoginUser(request);
        // 不是本人或管理员，不能直接获取所有信息！
        if (!question.getUserId().equals(userFeignClient.getLoginUser(request).getId()) && !userFeignClient.isAdmin(loginUser)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
    ...
    public BaseResponse<Boolean> deleteQuestionSubmit(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldQuestionSubmit.getUserId().equals(user.getId()) && !userFeignClient.isAdmin(user)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
